...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OA.Domin.ProductsMgt.Catigories.Catigory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OA.Domin.ProductsMgt.ProductCatigories.ProductCatigory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProductCatigories");
                });

            modelBuilder.Entity("OA.Domin.ProductsMgt.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OA.Domin.ProductsMgt.ProductCatigories.ProductCatigory", b =>
                {
                    b.HasOne("OA.Domin.ProductsMgt.Catigories.Catigory", "Catigory")
                        .WithMany("ProductCatigories")
                        .HasForeignKey("CatigoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OA.Domin.ProductsMgt.Products.Product", "Product")
                        .WithMany("ProductCatigories")
