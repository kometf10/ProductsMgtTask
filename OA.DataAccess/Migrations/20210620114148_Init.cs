        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatigoryId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCatigories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductCatigories_Catigories_CatigoryId",
                        column: x => x.CatigoryId,
                        principalTable: "Catigories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCatigories_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCatigories_CatigoryId",
                table: "ProductCatigories",
                column: "CatigoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCatigories_ProductId",
                table: "ProductCatigories",
                column: "ProductId");
        }
