...
namespace OA_API.LocalServices.Localization
{
    public class CommonLocalizationService
    {
        ...
        {
            var assemblyName = new AssemblyName(typeof(IStringLocalizer).GetTypeInfo().Assembly.FullName);
        ...
        public IEnumerable<LocalizedString> GetAll()
        {
